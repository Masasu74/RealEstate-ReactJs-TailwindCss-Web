...
function Hero() {
  return (
    <div className="h-screen   flex flex-col gap-16 pb-52 ">
      <Navbar />
      <div className="flex flex-col md:flex-row-reverse gap-10 md:gap-5 text-primary lg:relative">
        ...
        <div className="flex flex-col gap-3 md: md:basis-1/2 md:justify-center lg:gap-8 ">
          <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl lg:-mt-20">Modern living for everyone</h1>
          ...
          <div className=" bg-secondary  flex-col   flex items-center justify-between p-5 h-auto gap-3 md:flex-row md:absolute md:h-20 md:hidden lg:flex lg:top-80 lg:w-4/6 lg:absolute xl:top-96 lg:my-1">
            <select
              name=""
              id=""
              className=" border-2 border-blue w-full rounded-sm outline-0 drop-shadow-md duration-300 hover:border-hover focus:border-hover  focus:ring-0 px-1 py-3 lg:w-48"
            >
              <option value="">~Property type~</option>
              <option value="">House</option>
              <option value="">Apartment</option>
            </select>
            <div className=" border-2 border-blue w-full rounded-sm outline-0  hover:border-hover focus:border-hover  focus:ring-0 px-1 py-3 flex items-center justify-between bg-white lg:w-72">
